...
isTableLoading.value = true
  ...
  var requestOptions = {
   ...
   fetch(window.location.origin+"/api/enviro", requestOptions)
  .then(response => response.json())
  .then((response) => {
    enviroItems.value = response.data
        ...
        <tbody>
          ...
          >
           <!-- 👉 ID -->
            ...
            <td>
              {{ enviroItem.fpn_number }}
            </td>
            <td>
              {{ enviroItem.barcode }}
            </td>
            <td>
              {{enviroItem.site.name}}
            </td> 
            <td>
               {{ enviroItem.offender.first_name }} {{ enviroItem.offender.last_name }}
            </td> 
            <td>
              {{ enviroItem.offence.englishName }}
            </td> 
             <td>
            ...
            <td >
              <VChip
                ...
                v-if="enviroItem.fpn_status == 'paid'"
              >
                {{enviroItem.fpn_status.charAt(0).toUpperCase() + enviroItem.fpn_status.slice(1)}}
              </VChip>
            ...
            >
              <VBtn 
                :to="`/FPNList/${enviroItem.id}/details`"
                color="light"
              >
                <VIcon icon="mdi-eye-outline" :to="`/FPNList/${enviroItem.id}/details`"/>
              </VBtn>
            </td>
          </tr>
